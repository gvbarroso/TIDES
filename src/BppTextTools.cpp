/*
  This file is a copy of TextTools.cpp in the bpp-core libraries available in
  (https://github.com/BioPP/bpp-core/blob/master/src/Bpp/Text/TextTools.cpp)
