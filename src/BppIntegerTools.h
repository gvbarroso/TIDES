/*
  This file is a copy of IntegerTools.h in the bpp-core libraries available in
  (https://github.com/BioPP/bpp-core/blob/master/src/Bpp/Numeric/IntegerTools.h)
